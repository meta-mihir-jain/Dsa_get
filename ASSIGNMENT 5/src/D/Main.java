	...
	public static void main(String[] args) throws IOException 
	{
		...
		switch(choice){
			case 1:
				...
				key = scan_instance.next();
				System.out.println("1.Enter value");
				String value = scan_instance.next();
			...
			case 5:
				...
				String lowerBound = scan_instance.next();
				System.out.println("Enter upper bound");
				String upperBound = scan_instance.next();
	...
	private static void employeeLinkedList() {
		...
		while(true){
			...
			case 1:
				...
				int salary = scan_instance.nextInt();
				System.out.println("Enter Employee age");
				int age = scan_instance.nextInt();
